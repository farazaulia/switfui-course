...
//  DesignCode
//
//  Created by Faraz Muhammad Aulia on 20/03/20.
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificates is proff that Faraz Aulia has achieved the UI Design course with approval from a Design+Code instructor.")
